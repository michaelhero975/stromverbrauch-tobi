...
new Chart(document.getElementById('dailyChart'),{{type:'line',data:{{labels:DATA.daily_labels,datasets:[{{label:'kWh',data:DATA.daily_kwh,borderColor:'#888',backgroundColor:'rgba(136,136,136,0.08)',tension:0.3,fill:true,pointBackgroundColor:'#888',pointRadius:3}}]}},options:co()}});
